...
\begin{itemize}[nosep]
    \item \textbf{bf16 pruned} (1.5\,GB, 36\% smaller): \url{https://huggingface.co/AtomGradientOpenSource/Qwen3-TTS-0.6B-CustomVoice-bf16-pruned-vocab-lite}
    \item \textbf{4-bit pruned} (808\,MB, 67\% smaller): \url{https://huggingface.co/AtomGradientOpenSource/Qwen3-TTS-0.6B-CustomVoice-4bit-pruned-vocab-lite}
\end{itemize}
